...
//             stroke="#10b981"
//             fill="url(#areaGradientSecondary)"
//             name="Avg. List Cost (BDT)"
//           />
//         </RechartsAreaChart>
//       </ResponsiveContainer>
//       <div className="flex justify-between mt-2">
//         <span className="text-xs text-muted-foreground">Total Spent (BDT)</span>
//         <span className="text-xs text-muted-foreground">Avg. List Cost (BDT)</span>
//       </div>
//     </div>
//   );
// }

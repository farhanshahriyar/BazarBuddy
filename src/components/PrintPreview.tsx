    ...
    <div className="p-6 max-w-5xl mx-auto bg-gray-50">
      ...
      <div ref={printRef} className="bg-white p-8 shadow-md rounded-xl">
        <header className="mb-6 border-b pb-4">
          ...
          <p className="text-sm text-gray-500 mt-1">Generated by BazarBuddy</p>
        </header>
        ...
        <Table className="w-full print-table text-sm" style={{ fontFamily: "'Noto Sans Bengali', Arial, sans-serif" }}>
          <TableHeader>
            <TableRow className="bg-orange-600 text-white text-sm">
              <TableHead className="text-white text-left">Item</TableHead>
              <TableHead className="text-white text-left">Quantity</TableHead>
              <TableHead className="text-white text-left">Unit</TableHead>
              <TableHead className="text-white text-right price-column">Est. Price (৳)</TableHead>
            </TableRow>
          </TableHeader>
          ...
          <TableBody>
            {list.items.map((item: any) => (
              <TableRow key={item.id}>
                ...
                <TableCell className="border text-gray-950 border-gray-200 hover:bg-gray-400">{item.quantity}</TableCell>
                <TableCell className="border text-gray-950 border-gray-200 hover:bg-gray-400">{item.unit}</TableCell>
          ...
          <TableFooter>
            <TableRow className="bg-gray-100 font-semibold">
              <TableCell colSpan={3} className=" text-gray-950 hover:bg-gray-400 text-right border border-gray-200">Total:</TableCell>
